...
const VOLTAGE_FILE_NAME: &'static str = "images/dvoc_1ph_rl_sim_voltage.png";
const THETA_FILE_NAME: &'static str = "images/dvoc_1ph_rl_sim_thetas.png";
const POWER_OUT_FILE_NAME: &'static str = "images/dvoc_1ph_rl_sim_powers.png";
const CURRENT_OUT_FILE_NAME: &'static str = "images/dvoc_1ph_rl_sim_currents.png";
const DELTA_OUT_FILE_NAME: &'static str = "images/dvoc_1ph_rl_sim_deltas.png";
